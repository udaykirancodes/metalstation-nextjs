...
<div className={Nav.searchcontainer}>
  ...
  <div className={Nav.nav_right}>
                    <li className={Nav.nav_item}><Link href="/buy"><a>Buy</a></Link></li>
                    <li className={Nav.nav_item}><Link href="/sellscrap"><a>Sell</a></Link></li>
                    ...
                    <button className={Nav.login}><Link href="/login"><a>Log in </a></Link><i className="fa-solid fa-angle-right"></i> </button>
                </div>
    </div>
