...
const Wishlist = () => {
  ...
  const {wishlist , removeFromWishlist , cart ,addToCart, setCart} = useContext(Context);
      ...
      <div className="container">
...

        {
          ...
          <div style={{height:'500px',width:'100%',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column'}}>
                ...
                <Link href="/ecommerce">
                <p style={{fontSize:'20px',color:'dodgerblue'}}> <i className="uil uil-arrow-left" ></i> go back</p>
                </Link>
          </div>
        }
